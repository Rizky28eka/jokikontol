...
class _DiagnosesListViewState extends State<DiagnosesListView>
  ...
  Future<void> _fetch() async {
    ...
    try {
      ...
      _logger.info('Fetched diagnoses list',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Daftar Diagnosis'),
        backgroundColor: colorScheme.surface,
        elevation: 0,
      ...
      floatingActionButton: isDosen
          ? FloatingActionButton.extended(
              onPressed: () {
                // TODO: Implement add new diagnosis
                Get.snackbar('Fitur Dalam Pengembangan', 'Kemampuan untuk menambah diagnosis baru akan segera hadir.');
              },
  ...
  Widget _buildHeader(BuildContext context, bool isWideScreen) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            '${_filteredItems.length} diagnosis keperawatan tersedia',
      ...
      child: Focus(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Cari nama atau deskripsi diagnosis...',
          ...
          if (!isDosen) {
            Get.dialog(
              AlertDialog(
                ...
                backgroundColor: colorScheme.surface,
                title: Text(item['name'] ?? 'Detail Diagnosis', style: textTheme.titleLarge),
             ...
             Get.snackbar('Fitur Dalam Pengembangan', 'Kemampuan untuk mengedit diagnosis akan segera hadir.');
          }
        },
        borderRadius: BorderRadius.circular(16),
        child: Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              isSearching ? 'Tidak Ada Hasil' : 'Belum Ada Diagnosis',
              style: textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            Text(
              isSearching
                  ? 'Tidak ada diagnosis yang cocok dengan pencarian Anda.'
                  : 'Daftar diagnosis keperawatan masih kosong.',
              textAlign: TextAlign.center,
              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurfaceVariant),
            ),
          ],
