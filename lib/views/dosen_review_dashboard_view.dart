            ...
            Expanded(
              child: Obx(() {
                ...
                if (reviewController.errorMessage.isNotEmpty) {
                  return Center(child: Text('Error: ${reviewController.errorMessage}'));
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      child: ListTile(
                        title: Text('${form.type} - ${form.patient?.name ?? 'Unknown Patient'}'),
                        subtitle: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Mahasiswa: ${form.user?.name ?? 'Unknown'}'),
                            Text('Tanggal: ${form.createdAt.toString().split(' ')[0]}'),
                          ],
                        ),
                        trailing: Text(
